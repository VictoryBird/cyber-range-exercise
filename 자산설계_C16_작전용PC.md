...
# C4I 서버 접근 허용
netsh advfirewall firewall add rule name="C4I-COP" dir=out action=allow remoteip=192.168.130.11 remoteport=8080 protocol=tcp
netsh advfirewall firewall add rule name="C4I-Data" dir=out action=allow remoteip=192.168.130.12 remoteport=8000 protocol=tcp
netsh advfirewall firewall add rule name="C4I-Summary" dir=out action=allow remoteip=192.168.130.13 remoteport=8001 protocol=tcp
...
```
WAN: 192.168.110.254/24 (군 INT 측)
LAN: 192.168.130.1/24 (C4I 측)
